...
await conn.sendMessage(m.chat, {
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    title: 'ɪ ɴ ғ ᴏ  ʟ ʏ ɴ ɴ ʙ ᴏ ᴛ',
                    thumbnailUrl: 'https://telegra.ph/file/8345a7d4161c3eb472a39.jpg',
                    sourceUrl: 'https://whatsapp.com/channel/0029VaoNzzlJJhzQTJBL5n0F',
                    mediaType: 1,
...
seconds: 18,
fileLength: 18,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ʟʏɴɴᴢxᴅ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VaoNzzlJJhzQTJBL5n0F', thumbnail: await (await fetch(thumb)).buffer(),}}  
  }) 
}
